...
function loadjquery() {
	if (loc.indexOf(".xml")!= -1){
		...
		document.write("<script src='https://www.ebi.ac.uk/inc/js/jquery.js' type='text/javascript'></" + "script>");
	}
}
...
if(document.layers){
	document.write('<script type="text/javascript" src="https://www.ebi.ac.uk/inc/js/netscape47.js"></script>');
}
...
if (navigator.userAgent.indexOf("MSIE") != -1) {
	document.write('<link rel="stylesheet"  href="https://www.ebi.ac.uk/inc/css/contents_IE.css"   type="text/css" />');
}

if(navigator.userAgent.indexOf("Safari") != -1) {
	document.write('<link rel="stylesheet"  href="https://www.ebi.ac.uk/inc/css/contents_Safari.css"   type="text/css" />');	
}
