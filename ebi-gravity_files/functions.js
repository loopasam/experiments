...
if (navigator.userAgent.indexOf("Camino") != -1) {
	document.write('<link rel="stylesheet"  href="https://www.ebi.ac.uk/inc/css/Camino.css"   type="text/css" />');
}
if (   (((navigator.userAgent).split("Linux").length)>1)   &&  (navigator.userAgent.indexOf("Opera") == -1)    ){
	document.write('<link rel="stylesheet"  href="https://www.ebi.ac.uk/inc/css/linux.css"   type="text/css" />');
}
if( (navigator.userAgent.split("Linux").length)>1  ){
	document.write('<link rel="stylesheet"  href="https://www.ebi.ac.uk/inc/css/linux.css"   type="text/css" />');
}
if (navigator.userAgent.indexOf("Opera") != -1) {
	document.write('<link rel="stylesheet"  href="https://www.ebi.ac.uk/inc/css/Opera.css"   type="text/css" />');
}
else if(navigator.userAgent.indexOf("Safari") != -1) {
	document.write('<link rel="stylesheet"  href="https://www.ebi.ac.uk/inc/css/Safari.css"   type="text/css" />');	
}
else if(navigator.userAgent.indexOf("Netscape") != -1) {
	document.write('<link rel="stylesheet"  href="https://www.ebi.ac.uk/inc/css/Netscape.css"   type="text/css" />');	
}
else if (  (navigator.userAgent.indexOf("Firefox") != -1) && (navigator.userAgent.indexOf("Macintosh") != -1)   ){
	document.write('<link rel="stylesheet"  href="https://www.ebi.ac.uk/inc/css/MacFirefox.css"   type="text/css" />');
}
	...
	document.write('<link rel="stylesheet"  href="https://www.ebi.ac.uk/inc/css/OldGecko.css"   type="text/css" />');
}
else{}

if (navigator.userAgent.indexOf("(Macintosh") != -1) {
	document.write('<link rel="stylesheet"  href="https://www.ebi.ac.uk/inc/css/mac_template.css"   type="text/css" />');
}

try{
	//if(window.parent){
		if(window.parent.isHomePage){
			document.write('<link rel="stylesheet"  href="https://www.ebi.ac.uk/inc/css/home.css"   type="text/css" />');
			if(navigator.userAgent.indexOf("MSIE") != -1) {
				document.write('<link rel="stylesheet"  href="https://www.ebi.ac.uk/inc/css/home_IE6.css"   type="text/css" />');
			}
			if(navigator.userAgent.indexOf("MSIE 7") != -1) {
				document.write('<link rel="stylesheet"  href="https://www.ebi.ac.uk/inc/css/home_IE7.css"   type="text/css" />');
			}
			if( (navigator.userAgent.split("Linux").length)>1  ){
				document.write('<link rel="stylesheet"  href="https://www.ebi.ac.uk/inc/css/home_linux.css"   type="text/css" />');
			}
			if( (navigator.userAgent.split("Macintosh").length)>1  ){
				document.write('<link rel="stylesheet"  href="https://www.ebi.ac.uk/inc/css/home_mac.css"   type="text/css" />');
			}
			if (navigator.userAgent.indexOf("Camino") != -1) {
				document.write('<link rel="stylesheet"  href="https://www.ebi.ac.uk/inc/css/home_mac.css"   type="text/css" />');	
			}
